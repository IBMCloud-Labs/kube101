...
[add clusters and regions](https://cloud.ibm.com/docs/containers?topic=containers-ha&locale=en)
...
5. If you want to undo your latest rollout of V2 the guestbook Docker image and revert back to V1, use:
   ```console
